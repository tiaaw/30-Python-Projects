...
One dat, {noun2} walked into the room and caught the {noun1} in the act. 

{noun2}: "What are you doing?"
{noun1}: "I'm just {verb1}ing, what's the big deal?"
{noun2}: "Well, it's not ever day that you see a {noun1} {verb1}ing in the middle of the day."
...
And so, {noun2} and {noun1} went off to {verb2} and had a great time. 
The end.
"""
